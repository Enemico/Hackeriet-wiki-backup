...
12¤h1. How to restart the doorsystem

The doorservice is now installed as a daemon and should get started on boot. Use regular "service" commands to start, stop, restart og check status.
